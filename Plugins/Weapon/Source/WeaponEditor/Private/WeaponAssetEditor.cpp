...
const FName FWeaponAssetEditor::ToolkitFName = "WeaponAssetEditor";
const FName FWeaponAssetEditor::ListViewTabId = "ListView";
const FName FWeaponAssetEditor::DetailsTabId = "Details";
const FLinearColor FWeaponAssetEditor::WorldCentricTabColorScale = FLinearColor(0, 0, 1);
